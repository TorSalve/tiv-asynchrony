...
{
    public class ExperimentController1 : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                if (XRInputModalityManager.currentInputMode.Equals(XRInputModalityManager.InputMode.TrackedHand) && !isCountDown && !isAvatarRunning && !isQuestionnaireRunning)
                {
