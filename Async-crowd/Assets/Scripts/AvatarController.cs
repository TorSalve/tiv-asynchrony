...
namespace AsyncCrowd
{
    public class AvatarController : MonoBehaviour
    {
        ...
        [SerializeField] private InputActionReference resetBodyTrackingAction;
        ...
        void Start()
        {
            resetBodyTrackingAction.action.performed += ResetBodyTrackingCalibration;
        ...
        private void ResetBodyTrackingCalibration(InputAction.CallbackContext context)
        {
